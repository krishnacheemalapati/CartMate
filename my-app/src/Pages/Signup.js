            ...
            <div className="signup-container">
                ...
                <form className="sign-up-form" onSubmit={handleSubmit}>
                    <div className="">
                        ...
                        <input onChange={(e) => setUsername(e.target.value)} className="username mb-4" type="text" placeholder=""></input>
                    </div>
                    <div className="">
                        <label className="my-2 text-white">Email</label>
                        <input onChange={(e) => setEmail(e.target.value)} className="email mb-4" type="email" placeholder=""></input>
                    </div>
                    <div className="">
                        <label className="my-2 text-white">Password</label>
                        <input onChange={(e) => setPassword(e.target.value)} className="password mb-4" type="password" placeholder=""></input>
                    </div>
                    <button className="sign-up">Create Account</button>
                </form>
                <p className="already-have" style={{ color: "white" }}>Already have an account? <Link style={{ color: "white", textDecoration: "none" }} to='/'>Sign in.</Link></p>
            </div>
